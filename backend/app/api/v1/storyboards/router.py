...
def create_storyboard(storyboard_data: StoryboardCreate, db: Session = Depends(get_db), user_id: int = Depends(get_current_user_id)):
...
def get_storyboards(project_id: int = None, db: Session = Depends(get_db), user_id: int = Depends(get_current_user_id)):
